...
describe('CommentRepositoryPostgres', () => {
  ...
  describe('behavior test', () => {
    ...
    describe('getCommentById function', () => {
      ...
      it('should pass from NotFoundError when comment exist', async () => {
        // Arrange
        const commentRepositoryPostgres = new CommentRepositoryPostgres(pool, {});
        ...
        // Action
        const detailComment = await commentRepositoryPostgres.getCommentById('comment-123');

        // Assert
        expect(detailComment.rows).toHaveLength(1);
      });
    });
  });
});
